    ...
    <main className="landing-page">
        ...
        <div className="landing-hero-content">
          <div className="landing-copy">
            ...
            <p className="landing-description">
              복잡한 일정은 가볍게 정리하고, 중요한 일에 더 많은 시간을
              써보세요. GearVIa Me가 오늘의 흐름을 함께 만들어 드립니다.
            </p>
            <div className="landing-cta-row">
              <Link className="landing-primary-cta" to="/signup">
                지금 시작하기 <span>→</span>
              </Link>
            ...
            <div className="landing-trust">
              <span className="landing-trust-dots">
                <i />
                <i />
                <i />
              </span>
          ...
          <div
            ...
            aria-label="일정 관리 화면 미리보기"
          >
            <div className="preview-topbar">
              <span className="preview-logo">
                <BrandLogo showName={false} compact />
              </span>
              <span className="preview-title">오늘의 일정</span>
            ...
            <div className="preview-body">
              ...
              <div className="preview-list">
                {previewTodos.map((todo) => (
                  <div
                    className={`preview-todo ${todo.done ? "is-done" : ""}`}
                    key={todo.title}
                  >
              ...
              <button className="preview-add" type="button">
                + 새 일정 추가
              </button>
            </div>
          </div>
      ...
      <section className="landing-features" id="features">
        ...
        <p className="section-description">
          필요한 기능만 담아, 계획을 세우는 시간은 줄이고 실행하는 시간은
          늘렸습니다.
        </p>
        <div className="feature-grid">
          <article className="feature-card">
            ...
            <h3>일간 플래너</h3>
            <p>오늘의 일정에 집중하고, 작은 완료를 차곡차곡 쌓아보세요.</p>
          </article>
          ...
          <article className="feature-card">
            <span className="feature-icon">◷</span>
            <h3>월간 목표</h3>
            <p>큰 목표부터 매일의 일정까지, 나만의 속도로 이어갈 수 있어요.</p>
          </article>
        </div>
      </section>
      ...
      <section className="landing-final-cta">
        ...
        <Link
          className="landing-primary-cta landing-primary-cta-dark"
          to="/signup"
        >
          무료로 시작하기 <span>→</span>
        </Link>
